"! This class is used to fill travel data into the table zrap100_atrav01A
CLASS zcl_rap100_gen_data_01A DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_01A IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '01A',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav01A.
*    DELETE FROM zrap100_dtrav01A.

    "insert travel demo data
    INSERT zrap100_atrav01A  FROM (
        SELECT
